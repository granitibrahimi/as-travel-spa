...
const SupplierTransactionLinksIndex = () => import('../../pages/Suppliers/TransactionLinks/Index.vue');
...
export default [
    ...
    // Transaction Links
    { path: '/suppliers/transaction-links', name: 'supplierTransactionLinks.list', component: SupplierTransactionLinksIndex },
];
