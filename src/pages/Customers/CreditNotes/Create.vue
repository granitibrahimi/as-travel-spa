...
// Create a customer credit note: a nested orders→persons editor scoped to a
// customer (route param). Mirrors the platform CreateCustomerCreditNoteAction
// payload (orders[], dates d.m.Y) — the same shape as customer invoices.
// Supplier/destination use the autosuggest endpoints; products come from the
// shared formOptions store.
...
<template>
    <AppLayout title="New credit note" fluid>
        <FullWidthBox title="New credit note" :collapsible="false" class="mb-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                ...
                <Button type="button" variant="primary" :loading="saving" @click="save">Create credit note</Button>
            </div>
        </div>
    </AppLayout>
</template>
