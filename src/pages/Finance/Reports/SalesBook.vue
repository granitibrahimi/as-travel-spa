...
const { loading, error, data, load } = useReport('/finance/reports/sales-book');

const from = ref(null);
const to = ref(null);
// TODO: Group options — waiting on the API for what this groups by.
        ...
        <div class="space-y-4">
            ...
            <FullWidthBox title="Filters" :collapsible="false">
                <div class="flex flex-wrap items-end gap-3">
                    ...
                    <Select v-model="group" :options="groupOptions" label="Group" placeholder="Choose…" class="min-w-[180px]" />
